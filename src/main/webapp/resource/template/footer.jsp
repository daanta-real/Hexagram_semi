...
<FOOTER><UL CLASS='footerContainer'>
	...
	<LI>세션 IDX (usersIdx) = '<%=session.getAttribute("usersIdx") %>', <%= session.getAttribute("usersIdx") == null ? "자료형이 아예 null임 (값 자체가 없음)" : session.getAttribute("usersIdx").getClass().getName() %></LI>

...
public class Junsung_ItemReplyDto {
	...
	// 2. Constructors
	public Junsung_ItemReplyDto() {
		super();
	}

	public Junsung_ItemReplyDto(int itemReplyIdx, int itemIdx, int usersIdx, int itemReplyTargetIdx, String itemReplyDetail) {
		super();

...
event_idx              REFERENCES item(item_idx) ON DELETE CASCADE,
event_file_upload_name VARCHAR2(256)             CONSTRAINT event_file_upname_unique        UNIQUE
                                                 CONSTRAINT event_file_upname_not_null      NOT NULL,

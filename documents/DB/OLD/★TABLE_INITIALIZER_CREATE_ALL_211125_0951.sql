...
INSERT INTO event VALUES(event_seq.NEXTVAL, 5, '강경 젓갈 축제'      , '강경젓갈시장에는 야간 경관을 조성해 강경을 찾는 관람객들에 아름다운 추억을 선사할 예정이다.', TO_DATE('2021-10-13', 'YYYY-MM-DD'), 0, 0);
INSERT INTO event VALUES(event_seq.NEXTVAL, 7, '괴산 고추 축제'      , '유기농의 메카, 괴산 방방곳곳 온-오프 투어'                                              , TO_DATE('2021-08-26', 'YYYY-MM-DD'), 0, 0);
INSERT INTO event VALUES(event_seq.NEXTVAL, 9, '영주 사과 축제'      , '가을이 익어가는 계절, ‘영주사과’를 온라인으로 만난다'                                    , TO_DATE('2021-10-13', 'YYYY-MM-DD'), 0, 0);

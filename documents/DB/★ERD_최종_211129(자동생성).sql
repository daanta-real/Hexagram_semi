...
CREATE TABLE `event_reply` (
	`event_reply_idx`	NUMBER(20)	NOT NULL	COMMENT 'PRIMARY KEY',
	`users_idx`	NUMBER(20)	NOT NULL	COMMENT 'PRIMARY KEY',
	`event_idx`	NUMBER(20)	NOT NULL	COMMENT 'PRIMARY KEY',
	`event_reply_detail`	VARCHAR2(2000)	NOT NULL,
	`event_reply_date`	DATE	NOT NULL	DEFAULT SYSDATE,
	`event_reply_idx2`	NUMBER(20)	NOT NULL	COMMENT 'REFERENCE',
	`event_reply_groupno`	NUMBER(20)	NOT NULL,
	`event_reply_depth`	NUMBER(20)	NOT NULL
);
...
ALTER TABLE `event_reply` ADD CONSTRAINT `FK_users_TO_event_reply_1` FOREIGN KEY (
	`users_idx`
)
REFERENCES `users` (
	`users_idx`

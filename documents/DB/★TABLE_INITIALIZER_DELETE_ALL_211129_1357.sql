...
-- 테이블 데이터 삭제 (course_like)
TRUNCATE TABLE course_like;

-- 테이블/시퀀스 삭제 (course_like)
DROP TABLE course_like CASCADE CONSTRAINTS;
...
-- 테이블 데이터 삭제 (event_reply)
TRUNCATE TABLE event_reply;

-- 테이블/시퀀스 삭제 (event_reply)

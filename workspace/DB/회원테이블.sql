...
users_phone char(13) not null check(regexp_like(users_phone, '^010-[0-9]{4}-[0-9]{4}$')),
users_grade VARCHAR2(12)  not null check(users_grade in ('일반회원', '관리자'))
);
...
insert into users(users_idx, users_id, users_pw, users_nick, users_email, users_phone, users_grade)
    values(course_seq.nextval, 'test11111', 'test11111', '테스트1111', 'test@test.com', '010-1111-1111', '일반회원');
